...
import logo_hidden from '../../assets/images/logo2.png';
			...
			<aside id="left-panel" className="left-panel">
				<nav className="navbar navbar-expand-sm navbar-default">
					...
					<div className="navbar-header">
						...
						<a className="navbar-brand hidden" href="./"><img src={logo_hidden} alt="Logo"/></a>
					</div>
						...
						<ul className="nav navbar-nav">
							...
							<li className="menu-item-has-children dropdown">
								...
								<ul className="sub-menu children dropdown-menu">
									<li><i className="fa fa-puzzle-piece"></i><Link to="/components/buttons">Buttons</Link></li>
									<li><i className="fa fa-id-badge"></i><Link to="/components/badges">Badges</Link></li>
